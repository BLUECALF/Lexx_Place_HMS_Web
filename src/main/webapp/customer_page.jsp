    ...
    <body style="background-image: url(https://imgcy.trivago.com/d_dummy.jpeg,f_auto,q_auto/if_iw_lte_ih,c_scale,w_236/if_else,c_scale,h_160/e_improve,q_auto:low//partnerimages/70/57/705786454.jpeg);
        ...
        <form>
            ...
            <div class="form-group">
                ...
                <%-- book room form --%>
                <form  action="booking_servlet" method="get"
                    class="form-group" 
            ...
            <input type="submit" value="Book Now" class="btn btn-success">            
                ...
                <%-- Cancel booking form --%>
                <form action="cancel_booking_servlet" method="post"
            ...
            <input type="submit" value="Cancel Now" class="btn btn-danger">            
        </form>
     </form>  
               ...
               class="form-group" style="background-color: greenyellow;
                      ...
                      margin: 40px;
                      border-radius: 20px">
            <h3>Access Resident Services</h3>
            <label>If you are checked in  Lexx Place Hotel You can access Other Services</label>
            
            <label>Just Click below </label><br>          
            <input type="submit" value="Resident Services" class="btn btn-success">            
        </form>
        </div>
        </div>
